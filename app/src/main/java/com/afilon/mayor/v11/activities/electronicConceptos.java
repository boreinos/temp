...
public class electronicConceptos extends AfilonActivity implements OnTwoButtonDialogFragmentListener, DataResponseCallback, DialogToConfirmDuiTwoBtns.DialogToConfirmDuiListener {
...
//    private CustomKeyboard mCustomKeyboardTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomKeyboard = new CustomKeyboard(electronicConceptos.this, R.id.keyboardview, R.xml.tenhexkbd);
...
//                escrudataMapString = b.getString("escrudataMapFilledOut");
                ...
                Intent search = new Intent(electronicConceptos.this,
                        Consts.RECACT);
            ...
            case 32:
                ...
                Intent inte = new Intent(electronicConceptos.this, Consts.PAPALETASACT);
                inte.putExtras(buc);
                startActivity(inte);
                finish();
                break;
    ...
    public void onNoButtonForTwoButtonDialogClickedX() {
        ...
        switch (noIndex) {
            ...
            case 33: //Errors were found and user want to cancel everything, he/she wont continue
                ...
                buc.putParcelable("com.afilon.tse.votingcenter", vc);
                buc.putParcelable("com.afilon.tse.escrudata", new Escrudata(vc.getJRV()));
                Intent inte = new Intent(electronicConceptos.this,
                        Consts.PAPALETASACT);
                inte.putExtras(buc);
                startActivity(inte);
                finish();
...
//                    bc.putParcelable("com.afilon.assembly.applog", applog); //CARLOS: 2014-09-18
                    Intent intent = new Intent(electronicConceptos.this,
                            Consts.PAPALETASACT);
                    intent.putExtras(bc);
...
//            ah.savePreferences("escrudataMap", escrudataMapString);
            ...
            if(Consts.LOCALE.equals(Consts.HONDURAS)&& getResources().getString(R.string.voteType).equals(Consts.DIRECT)){
                search= new Intent(electronicConceptos.this,
                        Consts.VOTECOUNTER);
            }else{
                search = new Intent(electronicConceptos.this,
                        Consts.RECACT);
