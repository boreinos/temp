...
public class ReclamosActivity1 extends AfilonActivity {

    private static final String CLASS_TAG = "ReclamosActivity1";
        ...
        nextBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (partyArrayList.get(0).getParty_votes().equals("0")) {
                    ...
                    switch (voteType){
                        case "DIRECT":
                            search = new Intent(ReclamosActivity1.this, Consts.CAMACT);
                    ...
                    switch (voteType){
                        case "DIRECT":
                            search = new Intent(ReclamosActivity1.this,
                                    Consts.CAMACT);
                            search.putExtras(b);
                            startActivity(search);
                            break;
                        case "PREFERENTIAL":
                            if (Consts.LOCALE.contains("HON")){
                                search = new Intent(ReclamosActivity1.this, Consts.CAMACT);
                            }else search = new Intent(ReclamosActivity1.this, Consts.CAMACT);
                            search.putExtras(b);
                            startActivity(search);
                            break;
                    }
...
//					Intent search = new Intent(ReclamosActivity1.this,
