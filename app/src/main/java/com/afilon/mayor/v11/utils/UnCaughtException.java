...
public class UnCaughtException implements UncaughtExceptionHandler {
    ...
    public void createDBBackup(){
		DatabaseAdapterParlacen db = new DatabaseAdapterParlacen(context);
		try {
			db.open();
			db.backupDatabase();
			db.close();
			...
			Log.e(UnCaughtException.class.getName(),"error while creating backup");
	...
	public void sendErrorMail(final StringBuilder errorContent) {
		...
		new Thread() {
			...
			public void run() {
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								Intent sendIntent = new Intent(
										Intent.ACTION_SEND);
								String subject = "Preferential Election App has crashed!";
				...
				builder.setMessage("La aplicacion parece tener una incompatibilidad con su dispositivo. Por favor cierre la aplicacion y comuniquese con su supervisor.");
				builder.show();
				Looper.loop();
			}
		}.start();
