...
public class conceptosCompare extends AfilonActivity implements
                ...
                if(entrarBtn.getText().toString().contains("CORREGIR")){
                    ...
                    if (firstColumnCompleted) {
                        ...
                        if (isDUIVerified_b) {
                            ...
                            if (y > 0)
                                ((ScrollView) findViewById(R.id.concepto_table_sv)).smoothScrollBy(0, (int) convertDpToPixel(60, conceptosCompare.this));
                        } else {
    ...
    public void onNoButtonForTwoButtonDialogClickedX() {
        ...
        switch (noIndex) {
            ...
            default:
                ...
                Intent intent = new Intent(conceptosCompare.this,
                        Consts.PAPALETASACT);
                intent.putExtras(bc);
